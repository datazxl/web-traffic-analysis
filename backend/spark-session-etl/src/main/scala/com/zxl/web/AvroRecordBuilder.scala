...
import com.zxl.parser.dataobject.{BaseDataObject, HbDataObject, McDataObject, PvDataObject}
import com.zxl.parser.utils.ParseUtils._
...
trait AvroRecordBuilder {
  ...
  def buildHeartbeat(hb: HbDataObject, session: Session): Heartbeat = {
