...
import com.zxl.parser.dataobject.{EvDataObject, HbDataObject, McDataObject, PvDataObject}
import com.zxl.parser.dataobject.dim.{AdInfo, ReferrerInfo, SiteResourceInfo}
import com.zxl.web.session.SessionGenerator
...
class SessionGeneratorTest extends FunSuite with SessionGenerator {
  ...
  test("testGroupDataObjects") {
    ...
    val sessionDatum = getSessions(sortedObjects)
