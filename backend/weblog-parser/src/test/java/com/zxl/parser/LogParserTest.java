...
public class LogParserTest {
    ...
    public void setUp(){
        ...
        cmds.add("hb");
        cmds.add("ev");
        ArrayList<AbstractDataObjectBuilder> dataObjectBuilders = new ArrayList<>();
        ...
        PvDataObjectBuilder pvDataObjectBuilder = new PvDataObjectBuilder(new TargetPageAnalyzer(new DefaultProfileConfigLoader(new MockProfileConfigLoader())));
        ...
        logParser = new LogParser(cmds, dataObjectBuilders);
    }
    @Test
    public void parse() {
