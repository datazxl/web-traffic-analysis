...
public class EvDataObjectBuilderTest {
    EvDataObjectBuilder eventDataObjectBuilder = new EvDataObjectBuilder();
    @Test
    public void doBuildDataObject() {
        ...
        List<BaseDataObject> baseDataObjects = eventDataObjectBuilder.doBuildDataObjects(preParsedLog);
        Assert.assertEquals(1, baseDataObjects.size());
        EvDataObject eventDataObject = (EvDataObject)baseDataObjects.get(0);
