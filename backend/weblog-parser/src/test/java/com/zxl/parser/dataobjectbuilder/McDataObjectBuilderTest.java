...
public class McDataObjectBuilderTest {
    private McDataObjectBuilder builder = new McDataObjectBuilder();
    @Test
    public void doBuildDataObject() throws UnsupportedEncodingException {
        ...
        List<BaseDataObject> baseDataObjects = builder.doBuildDataObjects(preParsedLog);
