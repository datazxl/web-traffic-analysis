...
public class PvDataObjectBuilderTest {
    ...
    public void setUp() throws Exception {
        pvDataObjectBuilder = new PvDataObjectBuilder(new TargetPageAnalyzer(new DefaultProfileConfigLoader(new MockProfileConfigLoader())));
    }
    ...
    public void doBuildDataObjects() {
        ...
        List<BaseDataObject> baseDataObjects = pvDataObjectBuilder.doBuildDataObjects(preParsedLog);
